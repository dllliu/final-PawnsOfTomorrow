...
public class ChessPuzzle{
  ...
  public static void fiftyMove(String checkType,ArrayList<String> locationList,ArrayList<String> piecesList,ArrayList<String> colorList, ArrayList<String> solution, String color, boolean yes) {
    //xy
    ChessBoard newBoard = new ChessBoard(locationList,piecesList,colorList);
    System.out.print("\033[H\033[2J");
    System.out.flush();
    newBoard.count50=97;
    while(true){
      System.out.println(newBoard.count50);
      System.out.println(newBoard.toString(ChessGame.otherColor(color)));
      System.out.println (newBoard.scoreSheet.toString());
      System.out.println(color + " enter your move");
      if (yes){
        System.out.println("This checks "+checkType);
        System.out.println("The move to continue is "+solution.get(0));
      }
      Scanner in = new Scanner(System.in);
      String move = in.nextLine();
      if (move.contains("resign")){
